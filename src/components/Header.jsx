        ...
        <div className="drawer">
          ...
          <div className="drawer-side z-10">
            ...
            <ul className="menu p-4 w-80 min-h-full bg-base-200 text-base-content mt-4">
              ...
              <li className="text-xl">
                <NavLink className="text-accent-content" to="/shipping-policy">
                  Shipping Policy
                </NavLink>
              </li>
              <li className="text-xl">
                <NavLink className="text-accent-content" to="/partners">
                  Partners
                </NavLink>
              </li>
              {!isLoggedIn && (
